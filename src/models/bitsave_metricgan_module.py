...
class BitSaveLitModule(LightningModule):
    ...
    def generator_step(self, generated_y: Tensor, original_y: Tensor) -> Tensor:
        ...
        total_loss = l1_loss + adversarial_loss * self.gamma
    ...
    def training_step(self, batch: Tuple[Tensor, Tensor, Tensor, Tensor], batch_idx: int):
        ...
        generated_y = self.forward(original_y)
        ...
        g_total_loss, g_l1_loss, g_adversarial_loss = self.generator_step(generated_y, original_y)
