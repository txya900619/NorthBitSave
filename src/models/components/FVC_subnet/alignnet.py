...
from .offsetcoder import OffsetDecodeNet, OffsetEncodeNet
...
class PCD_Align(nn.Module):
    """Alignment module using Pyramid, Cascading and Deformable convolution with 3 pyramid
    levels."""

    def __init__(self, nf=64, groups=8, out_channel_mv=128, compressoffset=True):
        super().__init__()
        ...
        self.offset_encoder = OffsetEncodeNet(out_channel_mv=out_channel_mv)
        self.offset_decoder = OffsetDecodeNet(out_channel_mv=out_channel_mv)
        self.deformable_convolution = DCNv1(
            nf,
            nf,
            3,
            stride=1,
