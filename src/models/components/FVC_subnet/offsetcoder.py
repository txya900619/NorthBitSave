...
from .basics import Padit, Resblocks


class OffsetEncodeNet(nn.Module):
    """Offset Encode Net."""

    def __init__(self, inp=64, out_channel_mv=128):
        super().__init__()
...
class OffsetDecodeNet(nn.Module):
    ...
    def __init__(self, out=64, out_channel_mv=128):
        super().__init__()
        ...
        self.deconv3 = nn.ConvTranspose2d(
            out_channel_mv, out, 5, stride=2, padding=2, output_padding=1
        )
